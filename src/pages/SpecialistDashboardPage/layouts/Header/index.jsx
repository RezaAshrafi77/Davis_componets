        ...
        <FieldSet title={title} className={styles.fieldset} type="header">
          <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
            <div className="flex lg:flex items-end w-full flex-wrap gap-x-2 gap-y-2 md:gap-y-4">
              <DateInput
                containerClassName={
                  "flex flex-1 min-w-[48%] md:min-w-[112px] md:max-w-[160px] lg:max-w-[260px] xl:max-w-[280px] md:ml-auto !gap-0.5"
                }
              ...
              <TextField
                containerClassName={
                  "flex flex-1 min-w-[48%] max-w-[48%] md:min-w-[112px] md:max-w-[160px] lg:max-w-[260px] xl:max-w-[280px] md:ml-auto !gap-0.5"
                }
                className={styles.textField}
                questionKey={"6620"}
                watch={watch}
