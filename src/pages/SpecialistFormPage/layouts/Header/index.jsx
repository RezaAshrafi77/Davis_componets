          ...
          <form className={styles.form} onSubmit={onSubmit}>
            <div className="flex w-full flex-wrap items-end gap-x-4 gap-y-3 md:gap-y-4 lg:flex">
              ...
              {Form_Inputs.map((item) => (
                <TextField
                  containerClassName={
                    "flex flex-1 min-w-[46%] !rounded-[3px] md:min-w-[112px] md:max-w-[160px] lg:max-w-[232px] xl:max-w-[236px] md:ml-auto !p-0 !bg-transparent !gap-0.5 !shadow-none"
                  }
              ...
              >
                ...
                <div
                  className={
                    "flex justify-between gap-1.5 md:gap-2 px-1 lg:px-2 py-[2.4px] md:py-[2.25px] border-[0.25px] border-solid bg-[#f7f7f7] !rounded-[2px] lg:!rounded border-black"
                  }
                >
