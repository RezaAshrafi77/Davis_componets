                ...
                <div className="flex flex-col p-4">
                    ...
                    >
                        <TextField
                            ...
                            questionKey="6620"
                            containerClassName={
                                "!flex-row items-center !justify-between rounded !px-2 !py-2 !shadow-primary !bg-white-lighter md:!w-[328px] !w-full !gap-5 "
                            }
                    ...
                    <div className="flex h-[30vh] flex-col gap-7 md:gap-2 lg:gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 w-full z-20">
                            {services?.map((service) =>
                                check_print_condition(ogrid[1576563125067], [
                                    service.id,
                                ]) ? (
                                    <div
                                        key={service.id}
