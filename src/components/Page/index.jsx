    ...
    return (
        <div
            className={
                styles.page +
                " " +
                "relative flex h-screen overflow-hidden w-full flex-col pb-4 lg:px-4 !bg-no-repeat !bg-contain !bg-bottom"
            }
        >
        ...
        lg:gap-x-12 lg:grid-cols-6 xl:grid-cols-6 w-full px-4 pt-4 pb-4 
